...
public class Tile {
     ...
     *
     * @param ownerID  of the player that owns the stone on this Tile. Set to <code>null</code> if there is no stone on this Tile.
     ...
     */
    public Tile(int ownerID, Property property, int playerCount,int x, int y) {
        this.OwnerID = ownerID;

        if (this.OwnerID <= playerCount && this.OwnerID > 0 && property != Property.DEFAULT)
     ...
     *
     * @param ownerID new owner of this Tile. <code>null</code> resets ownership
     */
