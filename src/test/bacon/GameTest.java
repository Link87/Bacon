...
public class GameTest {
    ...
    public void processMessage() {
        ...
        assertEquals(0, Game.getGame().getCurrentState().getPlayerFromNumber(1).getOverrideStoneCount());
        assertEquals(1, Game.getGame().getCurrentState().getPlayerFromNumber(1).getBombCount());
        ...
        assertEquals(GamePhase.PHASE_ONE, Game.getGame().getCurrentState().getGamePhase());
    }
}